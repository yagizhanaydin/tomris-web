...
export const tr: TranslationDictionary = {
  ...
  verification: {
    ...
    bannerBody:
      "Şimdilik siteyi gezebilirsin. Paylaşım, yorum ve mesajlaşma, kadın temsilcilerimiz seni doğruladıktan sonra açılır. Bu önlemi yalnızca senin huzurun ve güvenliğin için alıyoruz — umarız bunu anlayışla karşılarsın.",
