...
export const tr: TranslationDictionary = {
  ...
  profile: {
    title: "Profil",
    memberSince: "{days} gündür Tomris'te",
    memberSinceOne: "1 gündür Tomris'te",
    notFound: "Kullanıcı bulunamadı veya profil görüntülenemiyor.",
    addFriend: "Arkadaş ekle",
  ...
  chat: {
    ...
    requestJoinGroup: "Katılma isteği gönder",
    joinedGroup: "Gruba katıldın!",
    joinRequestSent: "Katılma isteğin lider onayına gönderildi.",
    joinRequestPending: "Onay bekleniyor",
    joinRequestsTitle: "Katılma istekleri",
    noJoinRequests: "Bekleyen istek yok.",
    approveJoin: "Kabul et",
    rejectJoin: "Reddet",
    kickMember: "Gruptan çıkar",
    kickConfirmYes: "Evet, çıkar",
    leaveGroup: "Gruptan ayrıl",
    leaveGroupConfirm: "Gruptan ayrılmak istediğine emin misin? Lider isen liderlik bir sonraki üyeye geçer.",
    membersTitle: "Üyeler",
    leaderBadge: "Lider",
    memberCount: "üye",
    adminBadge: "Lider",
